  ...
  <div class="bg-gray-50 min-h-screen">
    ...
    <div class="mx-auto px-4 py-12 sm:py-16 container">
      ...
      >
        ...
        >
          <div
            class="flex flex-col bg-white shadow-lg hover:shadow-xl rounded-lg h-full overflow-hidden transition-shadow duration-300"
          >
            <!-- Destination image -->
            <div
            ...
            <div class="flex flex-col flex-1 p-6">
              ...
              <div class="gap-4 grid grid-cols-2 mb-4 text-sm">
                <div v-if="destination.elevation">
                  <span class="text-gray-500">{{ t('elevation') }}:</span>
                  <span class="ml-1 font-medium">{{
                    destination.elevation
                  }}</span>
                </div>
                <div v-if="destination.bestTime">
